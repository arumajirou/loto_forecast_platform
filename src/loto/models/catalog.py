...
MODEL_SPECS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec(
        ...
        "p0",
        "lightgbm",
        ("probability", "ranking", "exogenous", "gpu_optional"),
    ...
    ModelSpec(
        ...
        "p0",
        "lightgbm",
        ("position", "exogenous", "gpu_optional"),
    ...
    ModelSpec(
        ...
        "p1",
        "xgboost",
        ("probability", "exogenous", "gpu_optional"),
    ...
    ModelSpec(
        ...
        "catboost",
        ("probability", "exogenous", "gpu_optional"),
        {"iterations": 400, "learning_rate": 0.03, "verbose": False},
    ),
    ModelSpec(
        "stats-naive",
        "statistical",
    ...
    ModelSpec(
        ...
        "p1",
        "neuralforecast",
        ("gpu", "auto_hpo", "optuna", "ray", "checkpoint"),
        notes="Official NeuralForecast AutoModel; backend/search resolved at runtime",
    ),
    ModelSpec(
        "nf-auto-lstm",
        "rnn",
    ...
    ModelSpec(
        ...
        "p1",
        "neuralforecast",
        ("gpu", "auto_hpo", "optuna", "ray", "checkpoint", "multivariate"),
        notes="Official NeuralForecast AutoModel; requires n_series and multivariate input",
    ),
    ModelSpec(
        "nf-auto-xlinear",
        "linear",
    ...
    ModelSpec(
        ...
        "p1",
        "autogluon",
        ("ensemble", "probabilistic", "zero_shot"),
    ),
    ModelSpec(
        "darts-ensemble",
        "framework",
    ...
    ModelSpec(
        ...
        "p1",
        "chronos",
        ("zero_shot", "fine_tuning", "exogenous"),
    ...
    ModelSpec(
        ...
        "p1",
        "timesfm",
        ("zero_shot", "fine_tuning", "exogenous", "gpu"),
    ),
    ModelSpec(
        "granite-ttm",
        "tsfm",
        ...
        "p1",
        "transformers",
        ("zero_shot", "fine_tuning", "gpu_optional"),
    ),
    ModelSpec(
        "tirex",
        "tsfm",
    ...
    ModelSpec(
        ...
        "p1",
        "tabpfn_time_series",
        ("zero_shot", "probability", "gpu_optional"),
    ),
)
...
def list_model_specs(
    *, priority: str | None = None, available_only: bool = False
) -> list[ModelSpec]:
