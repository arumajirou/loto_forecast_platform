...
Task = Literal[
    "candidate", "position", "position_series", "candidate_series", "foundation", "reconciliation"
]
...
_NF_FAMILY: dict[str, str] = {
    ...
    "TCN": "cnn",
    "BiTCN": "cnn",
    "DeepAR": "deep_probabilistic",
    "DeepNPTS": "deep_probabilistic",
    "MLP": "mlp",
    "NBEATS": "mlp",
    "NBEATSx": "mlp",
    "NHITS": "mlp",
...
_SF_FAMILY: dict[str, str] = {
    ...
    "WindowAverage": "baseline",
    "SeasonalWindowAverage": "baseline",
    "ConstantModel": "baseline",
    "ZeroModel": "baseline",
    "NaNModel": "baseline",
...
TSFM_MODELS: tuple[dict[str, Any], ...] = (
    {
        ...
        "class_name": "Chronos2Pipeline",
        "package": "chronos",
        "family": "tsfm",
        "priority": "p0",
        "notes": "highest-download TSFM; zero-shot, covariate-capable",
        "probabilistic": True,
    },
    {
        "model_id": "chronos-bolt-tiny",
        "repo_id": "amazon/chronos-bolt-tiny",
        "class_name": "ChronosBoltPipeline",
        "package": "chronos",
        "family": "tsfm",
        "priority": "p0",
        "notes": "fastest Chronos variant; CPU-viable",
        "probabilistic": True,
    },
    {
        "model_id": "chronos-t5-small",
        "repo_id": "amazon/chronos-t5-small",
        "class_name": "ChronosPipeline",
        "package": "chronos",
        "family": "tsfm",
        "notes": "T5 tokenised Chronos",
        "probabilistic": True,
    },
    {
    ...
    },
    {
        ...
        "class_name": "TimesFmModelForPrediction",
    ...
    },
    {
        ...
        "class_name": "TinyTimeMixerForPrediction",
        "package": "transformers",
        "family": "tsfm",
        "priority": "p0",
        "license": "Apache-2.0",
    ...
    },
    {
        ...
        "class_name": "PatchTSMixerForPrediction",
        "package": "transformers",
        "family": "tsfm",
    },
    {
    ...
    },
    {
        ...
        "package": "tirex",
        "family": "tsfm",
        "notes": "xLSTM-based; successor to TiRex",
    },
    {
        "model_id": "toto-open-base",
        "repo_id": "Datadog/Toto-Open-Base-1.0",
        "class_name": "TotoForecaster",
        "package": "toto",
        "family": "tsfm",
        "probabilistic": True,
        "notes": "observability-domain pretraining",
    },
    {
    ...
    },
    {
        ...
        "class_name": "SundialForPrediction",
        "package": "transformers",
        "family": "tsfm",
        "probabilistic": True,
    },
...
def _builtin_and_sklearn() -> list[ModelEntry]:
    ...
    return [
        ModelEntry(
            ...
            "builtin",
            "candidate",
            "UniformCandidateAdapter",
            priority="p0",
            capabilities=("probability", "ranking", "control"),
        ...
        ModelEntry(
            ...
            "builtin",
            "candidate",
            "FrequencyCandidateAdapter",
            priority="p0",
            capabilities=("probability", "ranking"),
            supports_probabilistic=True,
        ),
        ModelEntry(
            "position-median",
        ...
        ModelEntry(
            ...
            priority="p0",
            package="sklearn",
            capabilities=("position", "exogenous"),
...
def _framework_tier() -> list[ModelEntry]:
    return [
        ...
        ModelEntry(
            ...
            "DeepAREstimator",
            package="gluonts",
            capabilities=("position", "probability"),
            supports_probabilistic=True,
        ),
        ModelEntry(
            "reservoir-esn",
    ...
    for name in STATSFORECAST_MODELS:
        ...
        entries.append(
            ModelEntry(
                ...
                notes="mandatory control"
                if name in ("SeasonalNaive", "Naive", "HistoricAverage")
                else "",
            )
        )
