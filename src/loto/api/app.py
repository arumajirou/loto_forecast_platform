...
def create_app(
    ...
    *,
    ...
    def dashboard() -> str:
        return """<!doctype html><html lang='ja'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>Loto Forecast Platform __LOTO_VERSION__</title>
...
<div class='head'><div><h1>Loto Forecast Platform <small>__LOTO_VERSION__</small></h1><p class='muted'>Loto Trusted Vertical Slice compatible</p></div><span class='status' id='health'>loading</span></div>
