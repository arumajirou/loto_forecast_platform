...
def model_specs() -> list[ModelSpec]:
    specs = [
        _spec(
            ...
            {"freq": "$freq", "prediction_length": "$prediction_length", "context_length": "$context_length", "batch_size": 4, "num_batches_per_epoch": 1, "epochs": 1},
        ),
        _spec(
            "DeepAREstimator",
            ...
            {"freq": "$freq", "prediction_length": "$prediction_length", "context_length": "$context_length", "num_layers": 1, "hidden_size": 4, "batch_size": 4, "num_batches_per_epoch": 1, "num_parallel_samples": 4, "distr_output": "$distribution", "trainer_kwargs": "$trainer_kwargs"},
        ),
        _spec(
            "TiDEEstimator",
            ...
            32,
            ["freq", "prediction_length"],
            {"freq": "$freq", "prediction_length": "$prediction_length", "batch_size": 4, "num_batches_per_epoch": 1, "trainer_kwargs": "$trainer_kwargs"},
        ),
        _spec(
            "SimpleFeedForwardEstimator",
            ...
            24,
            ["prediction_length"],
            {"prediction_length": "$prediction_length", "hidden_dimensions": [4], "batch_size": 4, "num_batches_per_epoch": 1, "trainer_kwargs": "$trainer_kwargs"},
        ),
        _spec(
            "TemporalFusionTransformerEstimator",
            ...
            32,
            ["freq", "prediction_length"],
            {"freq": "$freq", "prediction_length": "$prediction_length", "num_heads": 1, "hidden_dim": 4, "variable_dim": 4, "batch_size": 4, "num_batches_per_epoch": 1, "distr_output": "$distribution", "trainer_kwargs": "$trainer_kwargs"},
        ),
        _spec(
            "WaveNetEstimator",
            ...
            32,
            ["freq", "prediction_length"],
            {"freq": "$freq", "prediction_length": "$prediction_length", "batch_size": 4, "num_batches_per_epoch": 1, "num_parallel_samples": 4, "trainer_kwargs": "$trainer_kwargs"},
        ),
        _spec(
            "DLinearEstimator",
            ...
            24,
            ["prediction_length"],
            {"prediction_length": "$prediction_length", "hidden_dimension": 4, "kernel_size": 3, "batch_size": 4, "num_batches_per_epoch": 1, "trainer_kwargs": "$trainer_kwargs"},
        ),
        _spec(
            "PatchTSTEstimator",
            ...
            {"prediction_length": "$prediction_length", "patch_len": 16, "batch_size": 4, "num_batches_per_epoch": 1, "trainer_kwargs": "$trainer_kwargs"},
        ),
        _spec(
            "LagTSTEstimator",
