"""NeuralForecast AutoSCINet class factory."""
...
def build_auto_scinet_class(
    *,
    base_auto: type[Any],
    basic_variant_generator: type[Any],
    random_sampler: type[Any],
    losses: Any,
    scinet_class: type[Any],
    tune: Any,
    module_name: str,
) -> type[Any]:
    class AutoSCINet(base_auto):
        """Ray/Optuna AutoModel wrapper for the local SCINet model."""
        ...
        def __init__(
            ...
            if search_alg is None:
                if backend == "ray":
                    ...
                    raise ValueError(f"unsupported AutoSCINet backend: {backend}")
            super().__init__(
                cls_model=scinet_class,
                h=h,
                loss=loss,
    ...
    AutoSCINet.__name__ = "AutoSCINet"
    AutoSCINet.__qualname__ = "AutoSCINet"
    AutoSCINet.__module__ = module_name
    return AutoSCINet
