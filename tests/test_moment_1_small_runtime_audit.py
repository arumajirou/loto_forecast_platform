...
def test_runtime_inference_passed() -> None:
    ...
    assert result["repo_id"] == ("AutonLab/MOMENT-1-small")

    assert result["revision"] == ("411e288267f82cce86296dbe4d6c8bc533cc162f")
...
def test_certification_scope_is_execution_only() -> None:
    result = _load_json(EVIDENCE_DIR / "runtime-result.json")
