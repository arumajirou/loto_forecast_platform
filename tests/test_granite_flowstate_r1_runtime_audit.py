...
def test_runtime_inference_passed() -> None:
    ...
    assert result["repo_id"] == ("ibm-granite/granite-timeseries-flowstate-r1")
    assert result["revision"] == ("05effc6cb39ee16dce9dd0064ed1a76e4b8ff464")
    ...
    assert result["certification_prediction_shape"] == [
        7,
        1,
        1,
    ]
    assert result["mean_prediction_shape"] == [
        7,
        24,
        1,
    ]
    assert result["quantile_prediction_shape"] == [
        7,
        9,
        24,
        1,
...
def test_progress_document() -> None:
    ...
    assert "### granite-flowstate-r1" in docs
