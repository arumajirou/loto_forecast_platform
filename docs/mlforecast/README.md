...
The `mlforecast` extra pins `mlforecast==1.1.0` and installs the eight estimator backends and Optuna. The full environment also pins MLForecast 1.1.0.
...
```bash
uv run --extra mlforecast loto-mlforecast \
