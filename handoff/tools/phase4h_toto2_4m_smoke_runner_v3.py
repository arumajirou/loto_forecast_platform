...
ORIGINAL_SOURCE_SHA = "8af95b2be18280589cbbb13aa1fc32dfb793767c"
SOURCE_FIX_SHA = "0a13c287e0f0fcc8f983be3512654524dad18b2c"
GENERATED = Path(f"/tmp/loto-phase4h-toto2-generated-v3-{os.getpid()}.py")
PYCACHE = Path(f"/tmp/loto-phase4h-toto2-pycache-v3-{os.getpid()}")


def fail(message: str, rc: int = 2) -> int:
    print("=" * 60)
    print("PHASE4H_TOTO2_4M_LAUNCHER_V3=FAILED")
...
def generate() -> str:
    ...
    if leaked:
        raise RuntimeError(f"PHASE4H_V3_OLD_TOKEN_LEAK:{leaked}")
    return text
