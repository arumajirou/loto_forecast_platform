...
from loto.merlion_campaign.dependency_gate import audit_uv_lock, write_inventory_csv, write_json
...
def main() -> int:
    ...
    report = audit_uv_lock(project / "uv.lock", project / "pyproject.toml")
