...
def main() -> None:
    ...
    csv_output = (
        OUTPUT_DIR
        / "numbers3_n1_deepar_only_results.csv"
    )

    json_output = (
        OUTPUT_DIR
        / "numbers3_n1_deepar_only_results.json"
    )

    predictions_output = (
        OUTPUT_DIR
        / "numbers3_n1_deepar_only_predictions.parquet"
    )
    ...
    if failed:
        print(
            "NUMBERS3_N1_DEEPAR_ONLY=PARTIAL"
        )
    else:
        print(
            "NUMBERS3_N1_DEEPAR_ONLY=PASS"
        )
