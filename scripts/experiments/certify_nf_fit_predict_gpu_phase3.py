...
PREDICTION_DIR = Path(
    "artifacts/runtime_certification/neuralforecast_fit_predict_gpu_phase3_predictions"
)
...
def main() -> None:
    ...
    if failed:
        print("NF_FIT_PREDICT_GPU_PHASE3=PARTIAL")
        raise SystemExit(1)

    print("NF_FIT_PREDICT_GPU_PHASE3=PASS")
