...
OUTPUT_DIR = ROOT / "artifacts" / "numbers3" / "n1_nf_phase1"
...
def main() -> None:
    ...
    csv_output = OUTPUT_DIR / "numbers3_n1_nf_phase1_results.csv"

    json_output = OUTPUT_DIR / "numbers3_n1_nf_phase1_results.json"

    predictions_output = OUTPUT_DIR / "numbers3_n1_nf_phase1_predictions.parquet"
    ...
    if failed:
        print("NUMBERS3_N1_NF_PHASE1=PARTIAL")
    else:
        print("NUMBERS3_N1_NF_PHASE1=PASS")
