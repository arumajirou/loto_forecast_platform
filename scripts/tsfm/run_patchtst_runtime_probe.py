#!/usr/bin/env python3
"""Run one fixed-revision PatchTST GPU inference probe."""
...
def main() -> int:
    ...
    try:
        ...
        prediction_finite = bool(torch.isfinite(prediction_outputs).all().item())
        ...
        payload.update(
            {
                ...
                "observed_mask_shape": tensor_shape(past_observed_mask),
